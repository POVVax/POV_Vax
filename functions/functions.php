		...
		if($content=="No" && strlen($upload_image) >= 1){
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6'>
					...
					<a href='single.php?post_id=$post_id' style='float:right;'><button class='btn btn-info' style='width:100px; background-color:#B53F49; border-color:#B53F49;'>Comment</button></a><br>
				</div>
				<div class='col-sm-3'>
				</div>
			</div><br><br>
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6'>
					...
					<a href='single.php?post_id=$post_id' style='float:right;'><button style='width:100px; background-color:#B53F49; border-color:#B53F49;' class='btn btn-info'>Comment</button></a><br>
				</div>
				<div class='col-sm-3'>
				</div>
			</div><br><br>
				...
				echo"
					<div class='row'>
						<div class='col-md-6 col-md-offset-3'>
							<div class='panel panel-info'  id='com-con'>
								<div class='panel-body'>
									<form action='' method='post' class='form-inline'>
										<textarea placeholder='Write your comment here...' class='pb-cmnt-textarea' name='comment'></textarea>
										<button class='btn btn-info pull-right' name='reply' id='rep' style=' background-color:#B53F49; border-color:#B53F49;'>Comment</button>
									</form>
								</div>
							</div>
						</div>
						...
						<div class='col-sm-6'>
							<div class='row' id='find_people'>
								<div class='col-sm-4'>
									...
									<img id='img-find' src='users/$user_image' width='150px' height='140px' title='$username' style='float:left; margin:1px;'/>
									</a>
								</div><br><br>
								<div class='col-sm-6'>
									<a style='text-decoration: none; cursor:pointer;color:#fff;' href='user_profile.php?u_id=$user_id'>
					...
					<div class='col-sm-3'>
						...
						<div class='col-sm-6'>
							<div class='row' id='find_people'>
								...
								<div class='col-sm-6'>
									<a style='text-decoration: none; cursor:pointer;color:#fff;' href='user_message.php?u_id=$user_id'>
									<strong><h2>$f_name $l_name</h2></strong></a>
								</div>
								<div class='col-sm-3'>
									</div>
